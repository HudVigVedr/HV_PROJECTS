        ...
        for company_name in company_names:
            ...
            if access_token:
                ...
                if row_count > threshold:
                    ...
                    _DEF.send_email_2fa(f"ErrorLog -> {script_name} / {script_cat}", error_details, _AUTH.email_recipient, _AUTH.email_sender, _AUTH.email_client_id, _AUTH.email_client_secret)
