...
api_full2 = "')/" + api_table + "?$select=Status,User_ID,Object_Type_to_Run,Object_ID_to_Run,Object_Caption_to_Run,3PL_Task_No,Description,Job_Queue_Category_Code&$filter=Status%20eq%20%27Error%27"
