...
script_name = "Check wmsServiceLedger"
...
if __name__ == "__main__":
    print("Comparing BC_wmsServiceLedger row counts between src and SQL/Staging...")
    ...
    for company_name in company_names:
        try:
            api = f"{api_full}{company_name}{api_table}"
            #api = f"{api_full}BMA"
