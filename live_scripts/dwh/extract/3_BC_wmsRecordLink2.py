...
script_name = "BC_wmsRecordLink2"
script_cat = "DWH"

# Variables for the destination table
sql_table = "dbo.BC_wmsRecordLink2"
columns_insert = [
    "[@odata.etag]"
      ,"Table_ID"
      ,"[No]"
      ...
      ,"[User]"
      ,"Attached_Date"
      ,"Document_Flow_Purchase"
      ,"Document_Flow_Sales"
      ,"Document_Flow_Service"
      ,"Entity"
]

# Variables for API request
api_table = "doc_attachements"
...
if __name__ == "__main__":
    ...
    try:
        ...
        for company_name in company_names:
            api = f"{api_full}{company_name}{api_full2}{api_table}{api_filter}"
