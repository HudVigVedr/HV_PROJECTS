...
script_name = "BC_bank_customers"
script_cat = "DWH_extract"

# Variables for the destination table
sql_table = "dbo.BC_bank_customer"
columns_insert = [
    "[@odata.etag]", "Customer_No", "Code", "Name", "Post_Code", 
    "Country_Region_Code", "Phone_No", "Fax_No", "Contact", 
    "Bank_Account_No", "SWIFT_Code", "IBAN", "Direct_Debit_Mandate_ID", 
    "Currency_Code", "Language_Code", "Entity"
]

# Variables for API request
api_table = "bank_klant"
