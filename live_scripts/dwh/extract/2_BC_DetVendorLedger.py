...
script_name = "BC_DetVendorLedger"
script_cat = "DWH_extract"


# Variables for the destination table
sql_table = "dbo.BC_DetVendorLedger"
entryno = "Entry_No"
...
api_table = "')/GedetLeveranciersPosten"
...
if __name__ == "__main__":
    ...
    try:
        ...
        for company_name in company_names:
            ...
            max_entry_no = max_entry_nos.get(company_name, 1)  # Default to 0 if not found
