...
script_name = "temp_customers"
script_cat = "temp"

# Variables for the destination table
sql_table = "dbo.temp_customers"
columns_insert = [
    "[@odata.etag]", "no", "statusCode3PL", "Entity"
]

# Variables for API request
api_table = "customers"
api_full = _AUTH.end_REST_BOLTRICS_BC + "/" + api_table + "?company="
api_filter = "&$select=no,statusCode3PL"
...
if __name__ == "__main__":
    ...
    try:
        ...
        for company_name in company_names:
            api = f"{api_full}{company_name}{api_filter}"
